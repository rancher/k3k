...
When set to false, a new userns is created for the pod. +
This field is alpha-level and is only honored by servers that enable the UserNamespacesSupport feature. + |  | 
| *`dns`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-dnsconfig[$$DNSConfig$$]__ | DNS provides custom configuration for coredns in the virtual +
cluster. + |  | 
|===
...
* xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-dnsconfig[$$DNSConfig$$]

[cols="25a,55a,10a,10a", options="header"]
|===
| Field | Description | Default | Validation
| *`customConfig`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customconfigmap[$$CustomConfigMap$$] array__ |  |  | 
|===
...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customconfigmap"]
=== CustomConfigMap
...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-dnsconfig"]
=== DNSConfig
