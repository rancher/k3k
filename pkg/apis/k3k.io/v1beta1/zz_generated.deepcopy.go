...
import (
	k3s_cattle_iov1 "github.com/k3s-io/api/k3s.cattle.io/v1"
	"k8s.io/api/core/v1"
...
func (in *ETCDSnapshotSpec) DeepCopyInto(out *ETCDSnapshotSpec) {
	*out = *in
	if in.S3ConfigSecret != nil {
		in, out := &in.S3ConfigSecret, &out.S3ConfigSecret
		*out = new(v1.SecretReference)
		**out = **in
	}
}
...
func (in *ETCDSnapshotStatus) DeepCopyInto(out *ETCDSnapshotStatus) {
	*out = *in
	...
	if in.Error != nil {
		...
		*out = new(k3s_cattle_iov1.ETCDSnapshotError)
		(*in).DeepCopyInto(*out)
	}
}
