...
When set to false, a new userns is created for the pod. +
This field is alpha-level and is only honored by servers that enable the UserNamespacesSupport feature. + |  | 
| *`dns`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdns[$$CustomDNS$$]__ | DNS provides custom configuration for coredns in the virtual +
cluster. + |  | 
|===
...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-coredns"]
=== CoreDNS
...
|===
| Field | Description | Default | Validation
| *`customConfig`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdnsconfig[$$CustomDNSConfig$$] array__ |  |  | 
|===
...
|===
| Field | Description | Default | Validation
| *`coreDNS`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-coredns[$$CoreDNS$$]__ |  |  | 
|===


[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdnsconfig"]
=== CustomDNSConfig
...
* xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-coredns[$$CoreDNS$$]
