...
func (in *CoreDNS) DeepCopyInto(out *CoreDNS) {
	*out = *in
	if in.CustomConfig != nil {
		...
		*out = make([]CustomDNSConfig, len(*in))
		copy(*out, *in)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomDNSConfig) DeepCopyInto(out *CustomDNSConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomDNSConfig.
func (in *CustomDNSConfig) DeepCopy() *CustomDNSConfig {
	if in == nil {
		return nil
	}
	out := new(CustomDNSConfig)
	in.DeepCopyInto(out)
	return out
}
