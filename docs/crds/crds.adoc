...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-poddisruptionbudgetsyncconfig"]
...
| *`podDisruptionBudgets`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-poddisruptionbudgetsyncconfig[$$PodDisruptionBudgetSyncConfig$$]__ | PodDisruptionBudgets resources sync configuration. + | { enabled:false } | 
