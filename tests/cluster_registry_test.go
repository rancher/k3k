...
var _ = When("a cluster with private registry configuration is used", Label("e2e"), Label(registryTestsLabel), func() {
	...
	BeforeEach(func() {
		...
		// configure the cluster with the private registry secrets
		cluster.Spec.PrivateRegistry = v1beta1.PrivateRegistryConfig{
			SecretName: "k3s-registry-config",
			TLSSecrets: map[string]v1beta1.CredentialSource{
				"ca": {
