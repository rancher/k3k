...
|===
| Field | Description | Default | Validation
| *`clusterName`* __string__ | ClusterName is the name of the cluster where the snapshot will be taken + |  | 
| *`snapshotName`* __string__ | SnapshotName defines the snapshot + |  | 
|===
