...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AppliedPolicyStatus) DeepCopyInto(out *AppliedPolicyStatus) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AppliedPolicyStatus.
func (in *AppliedPolicyStatus) DeepCopy() *AppliedPolicyStatus {
	if in == nil {
		return nil
	}
	out := new(AppliedPolicyStatus)
	in.DeepCopyInto(out)
	return out
}
