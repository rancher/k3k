...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CoreDNSOverrides) DeepCopyInto(out *CoreDNSOverrides) {
	*out = *in
	if in.Forwarders != nil {
		in, out := &in.Forwarders, &out.Forwarders
		*out = make([]CustomForwarder, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CoreDNSOverrides.
func (in *CoreDNSOverrides) DeepCopy() *CoreDNSOverrides {
	if in == nil {
		return nil
	}
	out := new(CoreDNSOverrides)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomForwarder) DeepCopyInto(out *CustomForwarder) {
	*out = *in
	if in.IPs != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomForwarder.
func (in *CustomForwarder) DeepCopy() *CustomForwarder {
	if in == nil {
		return nil
	}
	out := new(CustomForwarder)
	in.DeepCopyInto(out)
	return out
}
