...
func (in *CustomDNS) DeepCopyInto(out *CustomDNS) {
	*out = *in
	if in.Forwarders != nil {
		...
		*out = make([]CustomDNSForwarder, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CustomDNSForwarder) DeepCopyInto(out *CustomDNSForwarder) {
	*out = *in
	if in.Forwarders != nil {
		in, out := &in.Forwarders, &out.Forwarders
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CustomDNSForwarder.
func (in *CustomDNSForwarder) DeepCopy() *CustomDNSForwarder {
	if in == nil {
		return nil
	}
	out := new(CustomDNSForwarder)
	in.DeepCopyInto(out)
	return out
}
