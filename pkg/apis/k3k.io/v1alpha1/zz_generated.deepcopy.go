...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SyncConfigOptions) DeepCopyInto(out *SyncConfigOptions) {
	*out = *in
	if in.Selector != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SyncConfigOptions.
func (in *SyncConfigOptions) DeepCopy() *SyncConfigOptions {
	if in == nil {
		return nil
	}
	out := new(SyncConfigOptions)
	in.DeepCopyInto(out)
	return out
}
