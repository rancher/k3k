...
When set to false, a new userns is created for the pod. +
This field is alpha-level and is only honored by servers that enable the UserNamespacesSupport feature. + |  | 
| *`customDNS`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdns[$$CustomDNS$$]__ | CustomDNS provides custom configuration for coredns in the virtual +
cluster. + |  | 
|===
...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-corednsoverrides"]
=== CoreDNSOverrides
...
* xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdns[$$CustomDNS$$]

[cols="25a,55a,10a,10a", options="header"]
|===
| Field | Description | Default | Validation
| *`forwarders`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customforwarder[$$CustomForwarder$$] array__ | Forwarders configures the custom forwarding in coredns. + |  | 
|===
...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customdns"]
=== CustomDNS
...
|===
| Field | Description | Default | Validation
| *`overrides`* __xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-corednsoverrides[$$CoreDNSOverrides$$]__ | Overrides are written to a .overrides file which is included into the +
coredns configuration. + |  | 
|===


[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-customforwarder"]
=== CustomForwarder
...
* xref:{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-corednsoverrides[$$CoreDNSOverrides$$]

[cols="25a,55a,10a,10a", options="header"]
|===
| Field | Description | Default | Validation
| *`ips`* __string array__ | IPs is a set of IP addresses referencing recursors to forward requests to. + |  | MinItems: 1 +
items:Pattern: ((^((([0-9]|[1-9][0-9]|1[0-9]\{2}|2[0-4][0-9]|25[0-5])\.)\{3}([0-9]|[1-9][0-9]|1[0-9]\{2}|2[0-4][0-9]|25[0-5]))$)|(^(([0-9a-fA-F]\{1,4}:)\{7,7}[0-9a-fA-F]\{1,4}|([0-9a-fA-F]\{1,4}:)\{1,7}:|([0-9a-fA-F]\{1,4}:)\{1,6}:[0-9a-fA-F]\{1,4}|([0-9a-fA-F]\{1,4}:)\{1,5}(:[0-9a-fA-F]\{1,4})\{1,2}|([0-9a-fA-F]\{1,4}:)\{1,4}(:[0-9a-fA-F]\{1,4})\{1,3}|([0-9a-fA-F]\{1,4}:)\{1,3}(:[0-9a-fA-F]\{1,4})\{1,4}|([0-9a-fA-F]\{1,4}:)\{1,2}(:[0-9a-fA-F]\{1,4})\{1,5}|[0-9a-fA-F]\{1,4}:((:[0-9a-fA-F]\{1,4})\{1,6})|:((:[0-9a-fA-F]\{1,4})\{1,7}|:))$)) +
