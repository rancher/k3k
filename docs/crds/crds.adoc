...
[id="{anchor_prefix}-github-com-rancher-k3k-pkg-apis-k3k-io-v1beta1-appliedpolicystatus"]
=== AppliedPolicyStatus
...
|===
| Field | Description | Default | Validation
| *`name`* __string__ | Name is the name of the VirtualClusterPolicy currently applied to this cluster. + |  | 
