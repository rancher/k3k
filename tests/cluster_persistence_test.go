...
var _ = When("an ephemeral cluster is installed", Label("e2e"), Label("persistence"), func() {
...
var _ = When("a dynamic cluster is installed", Label("e2e"), Label("persistence"), func() {
	var virtualCluster *VirtualCluster
