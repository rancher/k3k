...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PrivateRegistryConfig) DeepCopyInto(out *PrivateRegistryConfig) {
	*out = *in
	if in.TLSSecrets != nil {
		in, out := &in.TLSSecrets, &out.TLSSecrets
		*out = make(map[string]CredentialSource, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PrivateRegistryConfig.
func (in *PrivateRegistryConfig) DeepCopy() *PrivateRegistryConfig {
	if in == nil {
		return nil
	}
	out := new(PrivateRegistryConfig)
	in.DeepCopyInto(out)
	return out
}
